...
export const CreateUpdateTask = ({ handleClose, taskById }) => {
    ...
    const [values, setValues] = useState({taskById});
                                ...
                                <Grid container justify="center">
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            defaultValue={values.taskById.title}
                                        ...
                                        <TextField
                                            ...
                                            variant="outlined"
                                            rows={"4"}
                                            defaultValue={values.taskById.description}
                                            onChange={handleChange}
                                        ...
                                        <TextField
                                            ...
                                            defaultValue={values.taskById.priority}
                                            onChange={handleChange}
                                            className={styles.inputField}
                                            fullWidth
                                            required
                                        ...
                                        <TextField
                                            ...
                                            name="dueDate"
                                            type="date"
                                            defaultValue={values.taskById.dueDate.slice(0, 10)}
                                            onChange={handleChange}
